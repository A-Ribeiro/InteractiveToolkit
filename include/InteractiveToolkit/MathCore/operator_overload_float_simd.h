...
namespace MathCore
{
    ...
    template <typename _type, typename _simd,
              typename std::enable_if<
                  ...
                  bool>::type = true>
    static ITK_INLINE vec4<_type, _simd> operator*(const mat4<_type, _simd> &mat, const vec4<_type, _simd> &vec) noexcept
    {
#if defined(ITK_SSE2)
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec4<_type, _simd> operator*(const vec4<_type, _simd> &vec, const mat4<_type, _simd> &mat) noexcept
    {
#if defined(ITK_SSE2)
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec3<_type, _simd> operator*(const mat3<_type, _simd> &mat, const vec3<_type, _simd> &vec) noexcept
    {
#if defined(ITK_SSE2)
        __m128 v0 = _mm_shuffle_ps(vec.array_sse, vec.array_sse, _MM_SHUFFLE(0, 0, 0, 0));
        __m128 v1 = _mm_shuffle_ps(vec.array_sse, vec.array_sse, _MM_SHUFFLE(1, 1, 1, 1));
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec3<_type, _simd> operator*(const vec3<_type, _simd> &vec, const mat3<_type, _simd> &mat) noexcept
    {
#if defined(ITK_SSE2)
        __m128 m0 = _mm_mul_ps(vec.array_sse, mat.array_sse[0]);
        __m128 m1 = _mm_mul_ps(vec.array_sse, mat.array_sse[1]);
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec2<_type, _simd> operator*(const mat2<_type, _simd> &mat, const vec2<_type, _simd> &vec) noexcept
    {
#if defined(ITK_SSE2)
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec2<_type, _simd> operator*(const vec2<_type, _simd> &vec, const mat2<_type, _simd> &mat) noexcept
    {
#if defined(ITK_SSE2)
        //__m128 transp = _mm_shuffle_ps(mat.array_sse, mat.array_sse, _MM_SHUFFLE(3, 1, 2, 0));
        __m128 a0 = _mm_shuffle_ps(vec.array_sse, vec.array_sse, _MM_SHUFFLE(1, 0, 1, 0));
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE quat<_type, _simd> operator^(const quat<_type, _simd> &a, const quat<_type, _simd> &b) noexcept
    {
#if defined(ITK_SSE2)
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec3<_type, _simd> operator*(const quat<_type, _simd> &a, const vec3<_type, _simd> &v) noexcept
    {
        //
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec4<_type, _simd> operator*(const quat<_type, _simd> &a, const vec4<_type, _simd> &v) noexcept
    {
        //
        // non normalized multiplication of the quaternion
        //
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec3<_type, _simd> operator*(const vec3<_type, _simd> &v, const quat<_type, _simd> &a) noexcept
    {
        //
        // non normalized multiplication of the quaternion
        //
              ...
              typename std::enable_if<
                  std::is_same<_type, float>::value &&
                      (std::is_same<_simd, SIMD_TYPE::SSE>::value ||
                       std::is_same<_simd, SIMD_TYPE::NEON>::value),
                  bool>::type = true>
    static ITK_INLINE vec4<_type, _simd> operator*(const vec4<_type, _simd> &v, const quat<_type, _simd> &a) noexcept
    {
        //
        // non normalized multiplication of the quaternion
        //
