    ...
    namespace Util
    {
        ...
        template <typename _type,
                  typename std::enable_if<
                      ...
                      bool>::type = true>
        static ITK_INLINE void eulerEquivalent(const _type &_roll, const _type &_pitch, const _type &_yaw,
        ...
        template <typename _type, typename _simd,
                  typename std::enable_if<
                      std::is_floating_point<_type>::value,
                      bool>::type = true>
        static ITK_INLINE bool unproject(const vec3<_type, _simd> &_pointInWindow,
        ...
        template <typename _type, typename _simd,
                  typename std::enable_if<
                      std::is_floating_point<_type>::value,
                      bool>::type = true>
        static ITK_INLINE bool project(const vec3<_type, _simd> &worldPtn,
                                        const mat4<_type, _simd> &modelViewMatrix,
                                        const mat4<_type, _simd> &projectionMatrix,
                                        int viewportX, int viewportY, int viewportW, int viewportH,
        ...
        template <typename _type, typename _simd,
                  typename std::enable_if<
                      std::is_floating_point<_type>::value,
                      bool>::type = true>
        static ITK_INLINE void projectOnAxis(const vec3<_type, _simd> *points, int count, const vec3<_type, _simd> &axis, _type *outMin, _type *outMax) noexcept
        {
