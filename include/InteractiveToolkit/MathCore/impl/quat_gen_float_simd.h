...
namespace MathCore
{
    ...
    public:
        ...
        /// \return The quat
        ///
        static ITK_INLINE quatT fromAxisAngle(const type3 &axis, const _type &angle_rad) noexcept
        {
            _type sinAngle;
...
#error Missing ITK_SSE2 or ITK_NEON compile option
        ...
        /// \return The quat
        ///
        static ITK_INLINE quatT fromAxisAngle(const type4 &axis, const _type &angle_rad) noexcept
        {
        ...
        /// \return The quat
        ///
        static ITK_INLINE quatT fromAxisAngle(const type2 &axis, const _type &angle_rad) noexcept
        {
