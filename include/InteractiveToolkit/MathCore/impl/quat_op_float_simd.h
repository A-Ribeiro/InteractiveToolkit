...
#error Missing ITK_SSE2 or ITK_NEON compile option
        ...
        ///
        static ITK_INLINE quatT normalize(const quatT &vec) noexcept
        {
#if defined(ITK_SSE2)
...
#error Missing ITK_SSE2 or ITK_NEON compile option
        ...
        ///
        static ITK_INLINE _type sqrLength(const quatT &a) noexcept
        {
        ...
        /// \return The length
        ///
        static ITK_INLINE _type length(const quatT &a) noexcept
        {
...
#error Missing ITK_SSE2 or ITK_NEON compile option
        ...
        /// \param yaw radians
        ///
        static ITK_INLINE void extractEuler(const quatT &q, _type *roll, _type *pitch, _type *yaw) noexcept
        {
#if defined(ITK_SSE2)
...
#error Missing ITK_SSE2 or ITK_NEON compile option
        ...
        ///
        static ITK_INLINE quatT inverse(const quatT &q) noexcept
        {
        ...
        ///
        static ITK_INLINE quatT moveSlerp(const quatT &currentParam, const quatT &target, const _type &maxAngleVariation) noexcept
        {
