...
namespace MathCore
{
    ...
    public:
        ...
        ///
        static ITK_INLINE type4 clamp(const type4 &value, const type4 &min, const type4 &max) noexcept
        {
            return type4(
                OP<_type>::clamp(value.x, min.x, max.x),
                OP<_type>::clamp(value.y, min.y, max.y),
                OP<_type>::clamp(value.z, min.z, max.z),
                OP<_type>::clamp(value.w, min.w, max.w));
        }
        ...
        ///
        static ITK_INLINE type4 normalize(const type4 &vec) noexcept
        {
        ...
        ///
        static ITK_INLINE _type angleBetween(const type4 &a, const type4 &b) noexcept
        {
            _type cosA = OP<_type>::clamp(
                OP<type3>::dot(OP<type3>::normalize(*(const type3 *)&a), OP<type3>::normalize(*(const type3 *)&b)),
                (_type)-1, (_type)1);
        ...
        ///
        static ITK_INLINE type4 cross(const type4 &a, const type4 &b)
        {
            return type4((a.y * b.z - a.z * b.y),
                         (a.z * b.x - a.x * b.z),
                         (a.x * b.y - a.y * b.x),
                         0);
        }
        ...
        ///
        static ITK_INLINE type4 reflect(const type4 &a, const type4 &N) noexcept
        {
        ...
        static ITK_INLINE bool refract_old(const type4 &rayDir, const type4 &normal, const _type &ni, const _type &nr, type4 *vOut)
        {
        ...
        ///
        static ITK_INLINE _type sqrLength(const type4 &a) noexcept
        {
        ...
        /// \return The length
        ///
        static ITK_INLINE _type length(const type4 &a) noexcept
        {
        ...
        ///
        static ITK_INLINE _type sqrDistance(const type4 &a, const type4 &b) noexcept
        {
            type4 ab = b - a;
        ...
        ///
        static ITK_INLINE _type distance(const type4 &a, const type4 &b) noexcept
        {
            type4 ab = b - a;
        ...
        ///
        static ITK_INLINE type4 quadraticClamp(const type4 &center, const type4 &point, const _type maxRadius) noexcept
        {
        ...
        {
            return OP<_type>::maximum(OP<_type>::maximum(a.x, a.y), OP<_type>::maximum(a.z, a.w));
        }
        ...
        ///
        static ITK_INLINE type4 maximum(const type4 &a, const type4 &b) noexcept
        {
            return type4(
                OP<_type>::maximum(a.x, b.x),
                OP<_type>::maximum(a.y, b.y),
                OP<_type>::maximum(a.z, b.z),
                OP<_type>::maximum(a.w, b.w));
        }
        ...
        {
            return OP<_type>::minimum(OP<_type>::minimum(a.x, a.y), OP<_type>::minimum(a.z, a.w));
        }
        ...
        ///
        static ITK_INLINE type4 minimum(const type4 &a, const type4 &b) noexcept
        {
            return type4(
                OP<_type>::minimum(a.x, b.x),
                OP<_type>::minimum(a.y, b.y),
                OP<_type>::minimum(a.z, b.z),
                OP<_type>::minimum(a.w, b.w));
        }
        ...
        ///
        static ITK_INLINE type4 abs(const type4 &a) noexcept
        {
            return type4(
                OP<_type>::abs(a.x),
                OP<_type>::abs(a.y),
        ...
        ///
        static ITK_INLINE type4 slerp(const type4 &a, const type4 &b, const _type &_lerp) noexcept
        {
        ...
        ///
        static ITK_INLINE type4 barylerp(const _type &u, const _type &v, const type4 &v0, const type4 &v1, const type4 &v2) noexcept
        {
        ...
        ///
        static ITK_INLINE type4 splineCatmullRom(const type4 &P0, const type4 &P1, const type4 &P2, const type4 &P3, const _type &t) noexcept
        {
            _type tt = t * t;
            _type ttt = tt * t;
        ...
        ///
        static ITK_INLINE type4 move(const type4 &current, const type4 &target, const _type &maxDistanceVariation) noexcept
        {
        ...
        ///
        static ITK_INLINE type4 moveSlerp(const type4 &currentParam, const type4 &targetParam, const _type &maxAngleVariation) noexcept
        {
            type3 current = *(const type3 *)&currentParam;
            type3 target = *(const type3 *)&targetParam;
