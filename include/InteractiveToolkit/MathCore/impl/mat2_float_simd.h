...
namespace MathCore
{
	...
	public:
		...
		static constexpr size_t array_count = 4;
		static constexpr size_t array_stride = 2;
...
#if defined(ITK_SSE2)
		ITK_INLINE mat2(const __m128& a)
		{
			array_sse = a;
		}
#elif defined(ITK_NEON)
		ITK_INLINE mat2(const float32x4_t& a)
		{
			array_neon = a;
		}
#endif
...
#error Missing ITK_SSE2 or ITK_NEON compile option
		...
		///
		ITK_INLINE vec2_extract_type& operator[](const int _col)
		{
