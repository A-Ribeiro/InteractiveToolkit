...
namespace MathCore
{
	...
	struct CONSTANT<quat<_type, _simd>>
	{
		...
		// C++11
		static constexpr ITK_INLINE type Identity() noexcept { return type(); }
		static constexpr ITK_INLINE type Zero() noexcept { return type((_type)0); }
		...
		static constexpr ITK_INLINE type _180_move_slerp_case() noexcept { return type((_type)7.707397e-04, (_type)7.719296e-04, (_type)7.707397e-04, (_type)9.999991e-01); }
